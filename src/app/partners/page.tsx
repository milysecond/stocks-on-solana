      ...
      <div style={{ maxWidth: 720, margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          {partners.map(p => (
            ...
            >
              <div style={{ fontSize: 14, fontWeight: 700, color: '#ff9900', letterSpacing: 2, marginBottom: 8 }}>
                {p.name}
              </div>
              <div style={{ fontSize: 11, color: '#666', lineHeight: 1.7, letterSpacing: 0.5 }}>
                {p.description}
              </div>
            </a>
          ))}
        ...
        <div style={{ marginTop: 64, padding: '24px', border: '1px dashed #2a2a2a', borderRadius: 8, textAlign: 'center' }}>
          ...
          <a
            href="mailto:hello@stocksonsolana.com"
            style={{ fontSize: 11, color: '#ff9900', letterSpacing: 2, textDecoration: 'none' }}
          >
